...
function detail(place){
    if(buttonId == "en"){
        window.location.href = "../detail/detail.html?id=en&place=" + place;
    }
    else if(buttonId == "tc"){
        window.location.href = "../detail/detail.html?id=tc&place=" + place;
    }
    else {
        window.location.href = "../detail/detail.html?id=sc&place=" + place;
    }
}